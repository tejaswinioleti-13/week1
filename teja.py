...
class TaskSmartApp(ctk.CTk):
    ...
    def _setup_sidebar(self):
        ...
        self.logo_label = ctk.CTkLabel(self.sidebar_frame, text="TaskSmart", font=ctk.CTkFont(size=20, weight="bold"),
        ...
        self.settings_label = ctk.CTkLabel(self.sidebar_frame, text="⚙ Settings", text_color=COLORS["secondary_text"])
    ...
    def _setup_dashboard(self):
        ...
        # Add Task Button
        add_task_btn = ctk.CTkButton(header_frame, text="➕ Add Task", fg_color=COLORS["danger"], hover_color="#c82333",
        ...
        self.recent_tasks_container = ctk.CTkFrame(self.dashboard_frame, fg_color=COLORS["sidebar_bg"], corner_radius=8)
    ...
    def update_dashboard_metrics(self):
        ...
        for i, (title, value, value_color, border_color, progress_type) in enumerate(cards):
            ...
            if progress_type == "progress":
                ...
                # Progress Bar
                progress_bar = ctk.CTkProgressBar(progress_frame, orientation="horizontal", height=8, corner_radius=4)
    ...
    def display_recent_tasks(self):
        ...
        ctk.CTkLabel(self.recent_tasks_container, text="Recent Tasks", font=ctk.CTkFont(size=18, weight="bold")).grid(
        ...
        summary_text = ctk.CTkLabel(summary_frame, text=f"{metrics['Total Tasks']} total | {pending_count} pending |",
                                    text_color=COLORS["secondary_text"], anchor="w")
        summary_text.grid(row=0, column=0, sticky="w")

        overdue_text = ctk.CTkLabel(summary_frame, text=f" {metrics['Overdue']} overdue", text_color=COLORS["danger"],
        ...
        for i, task in enumerate(TASKS):
            ...
            # 2. Due Date
            due_date_label = ctk.CTkLabel(task_list_frame, text=task["due_date"], text_color=COLORS["secondary_text"])
    ...
    def _create_card(self, parent, title, value, value_color=None, border_color=None):
        ...
        title_label = ctk.CTkLabel(card, text=title, text_color=COLORS["secondary_text"], font=ctk.CTkFont(size=14))
    ...
    def _create_quick_sections(self, parent):
        ...
        ctk.CTkLabel(quick_frame, text="Quick Overview", font=ctk.CTkFont(size=18, weight="bold")).grid(row=0, column=0,
                                                                                                        padx=15,
                                                                                                        pady=(15, 5),
                                                                                                        sticky="w")
        ...
        ctk.CTkLabel(activity_frame, text="Recent Activity", font=ctk.CTkFont(size=18, weight="bold")).grid(row=0,
                                                                                                            column=0,
                                                                                                            padx=15,
                                                                                                            pady=(15,
                                                                                                                  5),
        ...
        for i, activity in enumerate(activities):
            label = ctk.CTkLabel(activity_frame, text=f"• {activity}", text_color=COLORS["secondary_text"], anchor="w")
